# Power load shedding and battery endurance manual

## Start with a load sheet
...
Solar, vehicle charging and generators are variable. Enter a conservative daily recharge value based on what you can actually produce, not the label maximum. Cloud cover, shade, temperature, battery charging limits, inverter losses, fuel availability and maintenance can all reduce delivered energy.

## Combustion hazards
CDC disaster guidance emphasizes that portable generators and other fuel-burning devices must be used outdoors because carbon monoxide can accumulate indoors and kill without warning. Current CDC guidance commonly states at least 20 feet, about 6 metres, from the home and away from openings. Local fire and electrical requirements still apply.

## Decision record
If the energy plan changes, record why: new medical requirement, dead battery, lower solar production, fuel shortage, damaged cable, temperature risk, or communication need. A later shift can then distinguish a deliberate change from an accidental omission.
